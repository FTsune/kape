...
def main():
    ...
    <div class="grid-container">
        <div style="text-align: center;">
            ...
            <p style='color: black; margin-top: -20px; text-align: center; max-width: 100%; height: auto;'>Deep Learning Engineer</p>
        </div>
        <div style="text-align: center;">
            ...
            <p style='color: black; margin-top: -20px; text-align: center; max-width: 100%; height: auto;'>Full Stack Developer</p>
        </div>
        <div style="text-align: center;">
            ...
            <p style='color: black; margin-top: -20px; text-align: center; max-width: 100%; height: auto;'>Python Developer</p>
        </div>
        <div style="text-align: center;">
            ...
            <p style='color: black; margin-top: -20px; text-align: center; max-width: 100%; height: auto;'>Data Cleaner</p>
        </div>
    </div>
    <style>
